...
public abstract class InteractiveTileObject {
    ...
    public InteractiveTileObject(PlayScreen screen, Rectangle bounds) {
        ...
        shape.setAsBox((bounds.getWidth()/2)/Adventure.PPM,(bounds.getHeight()/2)/Adventure.PPM);
        fdef.shape=shape;
    ...
    public TiledMapTileLayer.Cell getCell(){
        ...
        return layer.getCell((int)(body.getPosition().x*Adventure.PPM/16), (int)(body.getPosition().y*Adventure.PPM/16));
    }
}
